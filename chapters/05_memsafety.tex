...
to \texttt{\_\_INSTR\_remember\_malloc(i8* \%3, i64 4)}. This memory is
...
\texttt{isRemembered(memory\_location)} to the extended pointer analysis. If it
...
The following extension is not directly bound to the stages, but it can amplify
